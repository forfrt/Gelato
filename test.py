...
to='hover,crosshair,pan,wheel_zoom,box_zoom,reset,save,box_select'

plot = figure(y_range=(-10, 10), plot_width=400, plot_height=400,tools=to) 

plot.line('x', 'y', source=source, line_width=3, line_alpha=0.6) 

# script,div = components(plot)
# return render(request,'xxx.html',{'script':script,'div':div})
...
layout = row( plot, widgetbox(amp_slider, freq_slider, phase_slider, offset_slider), ) 
